...
# 1. Telegram Botni orqa fonda (background) auto-restart bilan ishga tushirish (agar o'chirilmagan bo'lsa)
if [ "$DISABLE_TELEGRAM_BOT" != "true" ]; then
    ...
    echo "🤖 Telegram Bot is disabled via DISABLE_TELEGRAM_BOT=true."
fi
