...
export default function HologramPlant() {
  return (
    <div className="relative w-full max-w-[320px] aspect-square flex items-center justify-center mx-auto">
      ...
      {/* Inner scanning ring (very subtle) */}
      <motion.div
        className="absolute w-[85%] h-[85%] rounded-full border border-dotted border-[var(--color-primary)]/5 pointer-events-none"
        animate={{ rotate: 300 }}
      ...
      {/* Floating container */}
      <motion.div
        className="relative z-20 w-full h-full flex items-center justify-center" // Scale to full size (100%)
      ...
      >
        ...
        <img
          ...
          className="w-[90%] h-[90%] object-contain mix-blend-screen filter drop-shadow-[0_0_25px_rgba(0,255,136,0.5)] select-none pointer-events-none"
        />
      </motion.div>
